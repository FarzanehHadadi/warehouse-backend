...
func NewCategoryRepository(db *gorm.DB, rc *RepoCache) CategoryRepository {
	return &categoryRepository{
		BaseRepository: NewCachedBaseRepository[models.Category](db, rc, cachePrefixCategory, cacheTTLDefault),
	}
}
